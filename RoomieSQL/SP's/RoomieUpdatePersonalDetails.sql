-- FUNCTION: public.roomieupdateuserdetails(integer, numeric, numeric, numeric, text, text, text, text, text, text, text, text)

-- DROP FUNCTION IF EXISTS public.roomieupdateuserdetails(integer, numeric, numeric, numeric, text, text, text, text, text, text, text, text);
